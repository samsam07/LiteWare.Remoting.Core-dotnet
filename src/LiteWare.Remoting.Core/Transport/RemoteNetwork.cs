...
/// </summary>
public abstract class RemoteNetwork
{
    private readonly IRemoteServiceMediator _remoteServiceMediator;
    private readonly IMessageSerializer _messageSerializer;

    /// <summary>
    /// Initializes a new instance of the <see cref="RemoteNetwork"/> class with the specified remote service mediator and message serializer.
    /// </summary>
    ...
    /// </exception>
    protected RemoteNetwork(IRemoteServiceMediator remoteServiceMediator, IMessageSerializer messageSerializer)
    {
